...
public class WarnLogMessageHandler implements ILogMessageHandler {
    ...
    public void flushMessage(String sinkMessage, LogMessage logMessage) {
        if (logMessage.getSeverity().getSeverity() >= LOGGER_LEVEL && logMessage.getSeverity() == MessageSeverity.WARN && MessageSeverity.WARN.getSeverity() >= LOGGER_LEVEL) {
